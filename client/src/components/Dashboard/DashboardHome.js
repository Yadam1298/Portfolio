...
const DashboardHome = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.put("http://localhost:5000/api/homepage", payload)
      .then(() => {
  ...
  return (
    <div className="dashboard-home">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" name="profilePicUrl" value={formData.profilePicUrl} onChange={handleChange} />

        <h3>Contact Info</h3>
        <label>Email</label>
        <input type="email" name="contacts.email" value={formData.contacts.email} onChange={handleChange} />

        <label>GitHub</label>
        <input type="text" name="contacts.github" value={formData.contacts.github} onChange={handleChange} />

        <label>LinkedIn</label>
        <input type="text" name="contacts.linkedin" value={formData.contacts.linkedin} onChange={handleChange} />

        <label>WhatsApp</label>
        <input type="text" name="contacts.whatsapp" value={formData.contacts.whatsapp} onChange={handleChange} />
